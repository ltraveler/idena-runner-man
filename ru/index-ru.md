...
* _Ubuntu 20.04 (скрипт не проходил проверку на версиях ниже 20.04) и выше._

**На период валидации, во избежании перегрузки сервера, на случай оверсейла VPS, можно добавить 1-2 CPU.**
...
**вам нужно изменить порт ipfs_port_number для ipfs который вы использовали для установки idena-go инстанции. По умолчанию это порт # `40405`**;
8. `sudo visudo`\
**вам нужно найти и удалить строку относящуюся к удаляемому пользователю**.
