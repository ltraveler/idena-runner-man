...
introduction: "Скрипт (bash) для быстрой <strong>установки ноды Idena</strong> (idena-go) с автоматическими обновлениями для ОС Ubuntu 18.04 и выше. С помощью Idena Runner вы можете установить на сервер одну и больше нод."
---
